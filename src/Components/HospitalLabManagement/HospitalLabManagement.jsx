    ...
    <section className='abt-secton forumn-frm'>
      <div className="container">
        <div className="row">
          ...
          <div className="common-heading"><h2> <span className="inlne">Hospitals &amp;</span> Referring Laboratories </h2>
          ...
          <div className="col-lg-8">
              ...
              <div className="common-title drk animated fadeInUp"><h4>Types of MOUs</h4></div>
              <span className="difentate mb-2">Pathology Services in Bangalore</span>
              ...
              <div className="common-title drk animated fadeInUp"><h4>Reports</h4></div>
              <span className="difentate mb-2">Online Anand Lab Reports,<br></br> Medical Laboratory Services in Bangalore</span>
              ...
              <div className="common-title drk animated fadeInUp"><h4>Logistics</h4></div> 
              ...
              <div className="common-title drk animated fadeInUp"><h4>Value Added Services</h4></div> 
