...
function ThankYou() {
  ...
  return (
    <div style={{ minHeight:"100vh",display:'flex',justifyContent:'center',alignItems:'center',textAlign:'center',position:'relative' }}>
        ...
        <div style={{ zIndex:1 }}>
            <img src="https://cdn-icons-png.flaticon.com/128/556/556096.png" width="150px" className='mb-4' alt='img' />
            ...
            <Link to="/" style={{ color:'#fdb758' }}><b>Continue Booking</b> <i className="fa fa-arrow-right"></i></Link>
        </div>
    </div>
  )
}
