     ...
     <section className="pat-con">
         <div className="container">
             <div className="row">
                ...
                <div class="common-heading"><h2> <span className='inlne'>Patients &</span> Consumers </h2></div>
     ...
     <section className='loyality-program'>
        ...
        <div className="row">
            ...
            <div className="col-lg-7">
                ...
                <div class="common-heading lite"><h2> Loyalty Program </h2></div>
                    <ul>
     ...
     <section className='blood-colleion'>
        <div className="container">
            <div className="row align-items-center">
                    ...
                    <div class="common-heading"><h2> <span>“Drive-Through </span>Blood Collection service” </h2></div>
            ...
            <div className="row align-items-center">
                    ...
                    <div className="col-lg-7">
                    <div className="contnt-set">
                    <div class="common-heading"><h2> <span>“Multiple Collection Centres </span> across Bangalore” </h2></div>
            ...
            <div className="row align-items-center">
                    <div className="col-lg-7">
                    <div className="contnt-set">
                    <div class="common-heading"><h2> “Giving your Sample” </h2></div>
