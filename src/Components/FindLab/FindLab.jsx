...
<div className="container">
    <div className="row"> 
        ...
        <div className="common-heading"><h2> <span className='inlne'>Our</span> Locations </h2></div>
        ...
        <h3>Baner <span> Pune, Maharashtra </span></h3>  
        <ul>
        <li>
        <i className="fa fa-map-marker" aria-hidden="true"></i> 
        Ananya Clinic, Mont Vert Zenith, Flat No 101, 1st Floor, Opp. Kundan Garden, Baner, Pune - 411 045
        </li>  
        <li>
        <i className="fa fa-clock-o" aria-hidden="true"></i> 
        <strong>Week Days</strong>: 8.00 AM to 7.30 PM<br/>
