...
<html lang="en">
   <head>
      ...
      <title>Thank You | Neuberg Diagnostics</title>
   ...
   <body>
      <div class="page-container">
         ...
         <div class="thanks" style="padding: 70px 30px;">
			<h1 class="text-center text-success mb-0" style="font-size: 60px;"><i class="fa fa-check-circle" aria-hidden="true"></i></h1>
            <h2 class="text-center pb-2">Your submission has been successful!</h2>
			<h5 class="text-center">We have received your submission, and we'll be in touch with you soon.</h5>
         </div>
         <footer>
			<div class="row">
...
SOUTH AFRICA | UAE | USA </span>
	  ...
	  <a href="#" class="mobile-button">Request a call back</a>
