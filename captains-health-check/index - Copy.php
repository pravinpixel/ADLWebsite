...
<html lang="en">
   ...
   <div id="load" style=" background:url(https://neubergdiagnostics.com/static/images/overly.png) repeat; width:100%; display:none; height:100%; position:fixed;top:0; left:0;z-index: 999999 !important; padding-top:1%; ">
      ...
      <div class="page-container">
         ...
         <h1>Be healthy like Dhoni</h1> 
         <p class="text-purple">Find out the secret to Dhoni’s top form with his <br>personalised health check package</p>
         </div>
         </div> </div>
         </section>
         

         <!-- <section class="title-pack-block text-center">
              <div class="container">
          <div class="row">
         <div class="col-12">
          <h3><Span class="titlespan">Captain’s</span> <br>Health <br><Span class="titlespan">Check</span></h3>   
         <div class="packlogo"> <img src="images/checkup-logo.png" class="img-fluid" /></div>
         <p class="actual-price">Actual Price <span><i class="fa fa-inr" aria-hidden="true"></i>5500</span></p>
         </div>
         </div> </div>
         </section> -->
         ...
         <div class="slide-content">
								<h4>Captain's  <span> Health Check</span></h4>  
								<div class="price-div">
         ...
         <div class="form-bg" id="form-section ">
           ...
           <span>Know more about</span> <br>  
           Dhoni’s Personalised Health Check-Up </h1>
            <h6 class="text-center" >Our Partners In Health will be in touch with you. <br> Thank you.</h6>
         ...
         <div class="row anywere">
            <div class="col text-center">
               <h2>HEALTH CHECKS,<br> <span class="text-purple">ANYTIME ANYWHERE </span></h2>
               <p class="text-style1 text-center">Book a lab test from the comfort of your home and be visited by our certified phlebotomists.  Get your personalized smart reports online easily.</p>

               <p class="callus">
                 <a href="tel:+919700369700">+91 9700 36 9700</a>
                  <span>www.neubergdiagnostics.com</sapn>
               </p>
...
<div class="facts">Over 250+
   <span>Ciites in 4 countries</span>
</div>
</div>
...
<div class="facts">30 million  
   <span>Tests Per Annum</span>
</div>
</div>

<div class="col-3">
<div class="facts">150+ labs   
   <span>Network across India</span>
</div>
</div>
...
<div class="col-3">
<div class="facts">5500 pincodes 
   <span>For Home Collection</span>
</div>
</div>

<div class="col-lg-3">
<div class="facts">6000+ 
   <span>Variety of Tests</span>
</div>
</div>
...
<h3 class="text-center">Health ko asani se na lo.   Test ko aasani se karo.  Check out these videos</h3>
      ...
      <iframe width="100%" height="315" src="https://www.youtube.com/embed/3Vy1WNAwExY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
         ...
         <iframe width="100%" height="315" src="https://www.youtube.com/embed/N1M1aLXzuHM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

            <iframe width="100%" height="315" src="https://www.youtube.com/embed/2F0i0NIgrOA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

               <iframe width="100%" height="315" src="https://www.youtube.com/embed/RxbOWz0jYJ4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

                  <iframe width="100%" height="315" src="https://www.youtube.com/embed/p0zcxKPORdk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
         </div>
		
<div class="downloadapp text-center">
<p>Download the Neuberg Diagnostics App and get access to <br> world class diagnostic services<p>  
  <a href="https://play.google.com/store/apps/details?id=com.neubergdiagnostics" target="_blank"><img src="images/playstore.jpg"></a> 
  <a href="#" target="_blank"><img src="images/appstore.jpg"></a>
</div>
...
<h2>Effectively Manage Your Diabetes  </h2>
<p> Know your Diabetes Risk Assessment Score To begin </p>
...
<section class="sugarfit">
<div class="container">
   <div class="row">   <div class="col-lg-12 text-center">
<p>Don’t let Diabetes control you! 
Enroll in our 12 month personalized programme and experience a positive transformation <br><br>Presenting</p>

<img src="images/sugarfit-logo2.png" class="img-fluid" alt="" />
</div>

<div class="col-lg-12 text-center sugarfit-packprice">
<p> Special introductory price </p>
<span class="sugarprice1 actu">₹30,000</span> <span class="sugarprice2">₹24,999</span>
</div>
...
<h5>Neuberg Footprint</h5>

<p>Tamil Nadu | Andhra Pradesh | Bihar | Delhi NCR | Gujarat | Haryana | Jammu and Kashmir | Karnataka | Kerala I Madhya Pradesh | Maharashtra | Punjab | Rajasthan | Telangana | Chhattisgarh | Uttar Pradesh | West Bengal | Odisha</p>
<span>
UAE | SOUTH AFRICA | USA </span>
